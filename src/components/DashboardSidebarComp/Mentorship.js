            ...
            <div className="mentorship-panel">
              ...
              <div className="mentorship-content">
                <p>
                  ...
                  Participants will learn about market structure, basic trading
                  strategies, and essential tools for success.
                </p>
                <p>
                  Through hands-on exercises and engaging examples, newcomers
                  will develop a strong foundation in the world of options
                  trading, preparing them for more advanced topics.
                </p>
                <div className="telegram-access">
                  <p>Access the telegram channel here:</p>
                  <button className="btn btn-dark telegram-btn">
                    <a
                      ...
                      href="https://t.me/+nO3GSU_Jvts5MGE0"
                    >
                      <i className="telegram-icon">✈</i> Mentorship Telegram
                      Alerts
                    </a>
                  </button>
                  {/* <button
